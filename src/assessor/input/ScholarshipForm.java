...
//            reportData.put("userInitials", currentUser.getInitials());
            ...
            try {
                boolean success = DatabaseSaveHelper.saveReport("Scholarship", reportData);
                ...
                if(success) {
                    ...
                    JOptionPane.showMessageDialog(this,
                        "Failed to save scholarship record",
                        "Database Error",
                        JOptionPane.ERROR_MESSAGE);
                }
            } catch (Exception ex) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScholarshipForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
